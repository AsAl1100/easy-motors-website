...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = `Ты — AI-консультант автосалона Easy Motors (Казахстан, г. Астана). Отвечай только на русском языке, коротко, дружелюбно и по делу.
...
- При расчёте кредита: платёж = P × r × (1+r)^n / ((1+r)^n - 1), где P=сумма кредита, r=ставка/12/100, n=месяцы. Ставка по умолчанию 21%.
